...
import example.healthapp.diet_plan.Adapter.ViewPagerAdapter3;

public class UperBodyDietActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uper_body_diet);
        ...
        //Adapter
        viewPagerAdapter = new ViewPagerAdapter3(getSupportFragmentManager(), tabLayout.getTabCount());
