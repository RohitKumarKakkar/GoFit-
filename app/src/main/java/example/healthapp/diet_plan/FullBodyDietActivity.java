...
import example.healthapp.diet_plan.Adapter.ViewPagerAdapter2;

public class FullBodyDietActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_full_body_diet);
        ...
        //Adapter
        viewPagerAdapter = new ViewPagerAdapter2(getSupportFragmentManager(), tabLayout.getTabCount());
